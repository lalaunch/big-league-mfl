/* The Big League — team crests
   Swaps every MFL franchise icon for the hosted crest and adds a crest to report captions. */
(function(){
  'use strict';

  var HOST='https://lalaunch.github.io/big-league-mfl/assets/logos/';
  var LOGOS={
    '0001':HOST+'tampa-bay-roxx-gang.webp?v='+(window.BL_VERSION||'0'),
    '0002':HOST+'la-launch.webp?v='+(window.BL_VERSION||'0'),
    '0003':HOST+'reno-gamblers.webp?v='+(window.BL_VERSION||'0'),
    '0004':HOST+'bristol-steampunks.webp?v='+(window.BL_VERSION||'0'),
    '0005':HOST+'delafield-draft-attics.webp?v='+(window.BL_VERSION||'0'),
    '0006':HOST+'kansas-city-killers.webp?v='+(window.BL_VERSION||'0'),
    '0007':HOST+'brooklyn-brawlers.webp?v='+(window.BL_VERSION||'0'),
    '0008':HOST+'winnebago-campers.webp?v='+(window.BL_VERSION||'0'),
    '0009':HOST+'jersey-jackhammers.webp?v='+(window.BL_VERSION||'0'),
    '0010':HOST+'milwaukee-killer-pugs.webp?v='+(window.BL_VERSION||'0')
  };
