...
(function(){
  ...
  function trophyRow(teamName){
    ...
    var cup='<svg viewBox="0 0 48 58" aria-hidden="true"><path d="M9 13C1 14-1 24 9 28" fill="none" stroke="#4a2e00" stroke-width="4.2" stroke-linecap="round"/><path d="M39 13c8 1 10 11 0 15" fill="none" stroke="#4a2e00" stroke-width="4.2" stroke-linecap="round"/><path d="M9 13C1 14-1 24 9 28" fill="none" stroke="url(#bltg-handle)" stroke-width="2.6" stroke-linecap="round"/><path d="M39 13c8 1 10 11 0 15" fill="none" stroke="url(#bltg-handle)" stroke-width="2.6" stroke-linecap="round"/><path d="M8 9c0 15 6 22 16 23 10-1 16-8 16-23z" fill="url(#bltg-cup)" stroke="#4a2e00" stroke-width=".6"/><ellipse cx="24" cy="9" rx="16" ry="3.2" fill="url(#bltg-rim)"/><path d="M8 9a16 3.2 0 0 1 32 0" fill="none" stroke="#fff1b8" stroke-width="1.1"/><ellipse cx="16.5" cy="18" rx="2.4" ry="7.5" fill="#fff" opacity=".45" filter="url(#bltg-soft)"/><path d="M11 17q13 4 26 0" fill="none" stroke="#7a4f00" stroke-width=".7" opacity=".7"/><path d="M11 18.2q13 4 26 0" fill="none" stroke="#fff1b8" stroke-width=".5" opacity=".6"/><path d="M21 32h6v3c0 2 1.5 3 3.5 4h-13c2-1 3.5-2 3.5-4z" fill="url(#bltg-cup)" stroke="#4a2e00" stroke-width=".5"/><ellipse cx="24" cy="33.5" rx="4.5" ry="1.6" fill="#fff1b8" opacity=".55"/><path d="M13 39h22c2.5 0 4 1.5 4 4v3H9v-3c0-2.5 1.5-4 4-4z" fill="url(#bltg-base)"/><path d="M13 39h22" fill="none" stroke="#e3b447" stroke-width="1.2"/><rect x="16.5" y="41.5" width="15" height="3.4" rx=".6" fill="url(#bltg-plate)" stroke="#4a2e00" stroke-width=".4"/><rect x="6" y="46" width="36" height="8" rx="1.2" fill="url(#bltg-base)"/><path d="M7 46.6h34" fill="none" stroke="#5a5a5a" stroke-width=".8"/><path d="M6.5 53.4h35" fill="none" stroke="#000" stroke-width="1"/></svg>';
    return '<div class="blt-trophies" title="Big League Championships: '+years.join(', ')+'">'+'<svg class="blt-trophy-defs" width="0" height="0" aria-hidden="true" focusable="false"><defs><linearGradient id="bltg-cup" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#6d4300"/><stop offset=".16" stop-color="#e3b447"/><stop offset=".3" stop-color="#fff4c2"/><stop offset=".42" stop-color="#f3cf63"/><stop offset=".62" stop-color="#c8931a"/><stop offset=".84" stop-color="#8a5c05"/><stop offset="1" stop-color="#5a3900"/></linearGradient><linearGradient id="bltg-handle" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#fff1b8"/><stop offset=".5" stop-color="#d9a52c"/><stop offset="1" stop-color="#7a4f00"/></linearGradient><radialGradient id="bltg-rim" cx=".5" cy=".55" r=".6"><stop offset="0" stop-color="#2a1800"/><stop offset=".7" stop-color="#5a3a00"/><stop offset="1" stop-color="#c8931a"/></radialGradient><linearGradient id="bltg-base" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#0d0d0d"/><stop offset=".25" stop-color="#3b3b3b"/><stop offset=".45" stop-color="#151515"/><stop offset=".7" stop-color="#2c2c2c"/><stop offset="1" stop-color="#050505"/></linearGradient><linearGradient id="bltg-plate" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#fff0b0"/><stop offset=".5" stop-color="#d9a52c"/><stop offset="1" stop-color="#8a5c05"/></linearGradient><filter id="bltg-soft" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur stdDeviation="1.1"/></filter></defs></svg>'+
