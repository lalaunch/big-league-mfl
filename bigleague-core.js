...
(function(){
  ...
  function trophyRow(teamName){
    ...
    var cup='<svg viewBox="0 0 40 74" aria-hidden="true"><ellipse cx="20" cy="71" rx="13" ry="2.2" fill="#000" opacity=".45" filter="url(#bltg-soft)"/><path d="M20 27 L15.5 27 L11 66 L20 66 Z" fill="url(#bltg-standL)"/><path d="M20 27 L24.5 27 L29 66 L20 66 Z" fill="url(#bltg-standR)"/><path d="M20 27 L20 66" stroke="#ffffff" stroke-width=".5" opacity=".7"/><path d="M15.5 27 L11 66 M24.5 27 L29 66" fill="none" stroke="#4b5259" stroke-width=".5" opacity=".6"/><path d="M14 27.5h12v-1.6c0-1.2-1-2-2.4-2.4h-7.2c-1.4.4-2.4 1.2-2.4 2.4z" fill="url(#bltg-standTop)" stroke="#5d646b" stroke-width=".4"/><path d="M9.5 66h21l1.5 4h-24z" fill="url(#bltg-foot)"/><path d="M9.5 66h21" stroke="#ffffff" stroke-width=".7" opacity=".8"/><path d="M8 70h24" stroke="#2e343a" stroke-width="1"/><g transform="rotate(-36 20 15)"><ellipse cx="20" cy="15" rx="16.5" ry="9.6" fill="url(#bltg-ball)" stroke="#4b5259" stroke-width=".5"/><path d="M4.5 15q15.5-3.4 31 0" fill="none" stroke="#5d646b" stroke-width=".7" opacity=".7"/><path d="M4.5 15q15.5 3.4 31 0" fill="none" stroke="#ffffff" stroke-width=".6" opacity=".7"/><path d="M13 8.6h14" stroke="#4b5259" stroke-width="1.1" stroke-linecap="round"/><path d="M15 6.9v3.4M17.3 6.9v3.4M19.6 6.9v3.4M21.9 6.9v3.4M24.2 6.9v3.4" stroke="#4b5259" stroke-width=".9" stroke-linecap="round"/><ellipse cx="12" cy="10" rx="4.5" ry="2.2" fill="#fff" opacity=".55" filter="url(#bltg-soft)"/></g></svg>';
    return '<div class="blt-trophies" title="Big League Championships: '+years.join(', ')+'">'+'<svg class="blt-trophy-defs" width="0" height="0" aria-hidden="true" focusable="false"><defs><radialGradient id="bltg-ball" cx=".38" cy=".32" r=".75"><stop offset="0" stop-color="#ffffff"/><stop offset=".28" stop-color="#e9edf1"/><stop offset=".6" stop-color="#a9b1b9"/><stop offset=".85" stop-color="#6f777f"/><stop offset="1" stop-color="#4b5259"/></radialGradient><linearGradient id="bltg-standL" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#b9c0c7"/><stop offset=".55" stop-color="#f4f6f8"/><stop offset="1" stop-color="#e2e6ea"/></linearGradient><linearGradient id="bltg-standR" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#c9cfd5"/><stop offset=".5" stop-color="#8f979f"/><stop offset="1" stop-color="#5d646b"/></linearGradient><linearGradient id="bltg-standTop" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ffffff"/><stop offset="1" stop-color="#aab1b8"/></linearGradient><linearGradient id="bltg-foot" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#7d858c"/><stop offset=".45" stop-color="#eef1f4"/><stop offset="1" stop-color="#5a6168"/></linearGradient><filter id="bltg-soft" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur stdDeviation="1"/></filter></defs></svg>'+
